...
HD_PWD='/home/justin/github/2018_fall_hardware_software_codesign_lab/basic_integration/basic_integration.runs/design_1_basic_integration_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_basic_integration_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_basic_integration_0_1.tcl
