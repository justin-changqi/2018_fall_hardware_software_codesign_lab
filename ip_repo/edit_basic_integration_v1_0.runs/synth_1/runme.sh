...
HD_PWD='/home/justin/github/2018_fall_hardware_software_codesign_lab/ip_repo/edit_basic_integration_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_integration_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic_integration_v1_0.tcl
