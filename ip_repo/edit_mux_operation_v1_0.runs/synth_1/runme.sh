...
HD_PWD='/home/justin/github/2018_fall_hardware_software_codesign_lab/ip_repo/edit_mux_operation_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_operation_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_operation_v1_0.tcl
