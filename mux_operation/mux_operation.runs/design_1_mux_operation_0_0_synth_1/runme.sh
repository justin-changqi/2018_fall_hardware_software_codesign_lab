...
HD_PWD='/home/justin/github/2018_fall_hardware_software_codesign_lab/mux_operation/mux_operation.runs/design_1_mux_operation_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mux_operation_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mux_operation_0_0.tcl
