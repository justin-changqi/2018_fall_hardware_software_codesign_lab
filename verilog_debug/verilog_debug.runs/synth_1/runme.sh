...
HD_PWD='/home/justin/github/2018_fall_hardware_software_codesign_lab/verilog_debug/verilog_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ten_q.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ten_q.tcl
